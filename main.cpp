...
int main()
{
    ...
    cout<<"Enter the number of mechanics available"<<endl;
    cin>>size_mech;
    ...
    for(int i=0 ; i<size_cus ;i++)
    {
        ...
        {
            find_mech(x.get_mechid(), size_mech , arr_mech , index_mech);
            cout<<"Mr/Mrs "<<x.get_Name()<<" Has an appointment with the mechanic "<<arr_mech[index_mech].get_Name()<<" at time "<<x.get_app().hours<<":"<<x.get_app().mins<<endl;
        }
    }
